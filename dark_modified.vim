...
"   * g:airline#themes#dark_modified#palette.normal
"       * the colors for a statusline while in normal mode
"   * g:airline#themes#dark_modified#palette.normal_modified
"       * the colors for a statusline while in normal mode when the buffer has
"         been modified
"   * g:airline#themes#dark_modified#palette.visual
...
let g:airline#themes#dark_modified#palette.normal = airline#themes#generate_color_map(s:airline_a_normal, s:airline_b_normal, s:airline_c_normal)

" It should be noted the above is equivalent to:
" let g:airline#themes#dark_modified#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#dark_modified#palette.normal = {
...
let g:airline#themes#dark_modified#palette.replace = copy(g:airline#themes#dark_modified#palette.insert)
let g:airline#themes#dark_modified#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#af0000' , s:airline_b_insert[2] , 124     , ''     ]
let g:airline#themes#dark_modified#palette.replace_modified = g:airline#themes#dark_modified#palette.insert_modified
...
let g:airline#themes#dark_modified#palette.visual = airline#themes#generate_color_map(s:airline_a_visual, s:airline_b_visual, s:airline_c_visual)
...
let g:airline#themes#dark_modified#palette.inactive = airline#themes#generate_color_map(s:airline_a_inactive, s:airline_b_inactive, s:airline_c_inactive)
